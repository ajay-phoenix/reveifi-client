...
export function MyComponent({ handler, meta }: any) {
    ...
    return <input className="lib-inputtextfld" type="text" placeholder={t(`Enter ${meta.label}`)} {...handler()} />
}
...
const TextInputPassword1 = ({ handler, touched, hasError, meta }: any) => (
    <div>
...
class EditProfile extends Component<RouteComponentProps, any> {
    ...
    async componentDidMount() {
        ...
        this.singnUPForm.controls['mobile_number'].setValue(userData.mobile_number || '');
