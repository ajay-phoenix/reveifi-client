...
class BidDetail2 extends Component {
    constructor(props) {
        super(props)
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-12 col-sm-12">
                                            ...
                                            <div className="property-name">
                                                <p><Trans>Testing Property.</Trans></p>
                                            </div>
                                            ...
                                            <div className="offers_detail_table">
                                                ...
                                                <table className="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Trans>Loan Types</Trans>
                                                            </td>
                                                            <td>
                                                                <Trans>Aspire Money</Trans>
                                                            </td>
                                                        ...
                                                        <tr className="outer-tr">
                                                            <td colSpan={100}>
                                                                <Trans>34 Prospect Street #7, Jersey City, NJ, 07307, United States</Trans>
                                                            </td>
                        ...
                        <div className="row">
                            <div className="col-md-7 propertyChatUpper">
                                <div className="property-main">
                                    ...
                                    <div className="property-name">
                                        <p id="buying-room-inner">
                                            <Trans>Transaction table Chat (Buyer, Seller, Realtors, Lenders)</Trans>
                                        </p>
                                    </div>
                                </div>
                                <div className="propertyChatContent">
                                    <p className="para_align">
                                        <Trans>You Have Accepted Bidding From Justin</Trans>
                                    </p>
                                    <div className="detail-desc-para">
                                        <p>
                                            <Trans>That is what is required for an offer</Trans>
                                        </p>
                                    </div>
                                    <div className="detail-desc-para" id="inner-detil">
                                        <p>
                                            <Trans>You need these two documents for that</Trans>
                                        </p></div>
                                    <div className="detail-desc-para" id="detail-bottom">
                                        <p>
                                            <Trans>Thanks for sharing documents</Trans>
                                        </p></div>
