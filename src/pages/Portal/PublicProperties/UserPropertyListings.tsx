...
class UserPropertyListings extends React.Component<RouteComponentProps, any>{
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    async getPublicProperties() {
        ...
        this.setState({ loading: true, sort_by:sort_by })

        const user_id = window.location.pathname.split("/").pop();
        var params = '?filter='+this.state.filter+'&sort_by='+sort_by;
        var response = await UserService.getRealtorPropertiesById(user_id+params);
        var properties = [];
        var properties_ids = [];
    ...
    async sortProperties(){
        ...
        window.location.href = window.location.href.split('?')[0]+"?search="+sort_by;
        this.getPublicProperties()
                ...
                <div className="my-properties-page">
                    <div className="page-title">
                        {this.state.loading ?
                            ...
                            <Trans>Realtor Properties</Trans>
                        }
                    </div>
                    ...
                    <div className="container-fluid pl-0">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-12">
                                                ...
                                                <input type="text" className="form-control property-search-box mr-3" placeholder="" onChange={(e)=>this.setState({ filter: e.target.value })}/>
                        ...
                        {!this.state.loading ?
                            <div className="container-fluid row d-dir-row">
